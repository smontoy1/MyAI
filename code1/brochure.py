...
# Setting up the response prompt
...
# Write the Markdown brochure to an output file
# output_file = "brochure.md"
   # try:
       # with open(output_file, "w", encoding="utf-8") as f:
           # f.write(markdown_summary)
       # print(f"Brochure successfully written to '{output_file}'")
   # except Exception as e:
       # print(f"Failed to write brochure to file: {e}")
